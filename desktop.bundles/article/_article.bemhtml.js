var BEMHTML = function() {
  var cache,
    ...
    function $6(__$callback) {
        ...
        var __r76, __r80, __r77, __r78, __r79;
        var __this;
        __this = this;
        "";
    ...
    function $44(__$callback) {
        return __$callback.call(this, null, "footer");
    }
    function $49(__$callback) {
    ...
    function $142(__$callback) {
        ...
        function __$fn24(__$e, __$r) {
            ...
            while (true) {
                if (!(_$1sp = _$1sprops["pop"]())) {
                    break;
                } else {
                    __$i109 = _$1sctx[_$1sp];
                    if (__$i109) {
                        __$i121 = _$1sa[_$1sp] = _$1sctx[_$1sp];
                    } else {
                        __$i121 = __$i109;
                    }
                }
            }
            return __$callback.call(this, null, _$1sa);
        }
        var __$r23;
        ...
        var _$1sctx, _$1sprops, _$1sp, _$1sa;
        var __r72, __r73, __r74, __r75;
        var __this;
        __this = this;
        _$1sctx = this["ctx"];
        _$1sprops = [ "title", "target" ];
        _$1sp = typeof _$1sctx["url"];
        __$i22 = _$1sp === "undefined";
        if (__$i22) {
            __$i31 = __$i22;
        } else {
            __$i31 = _$1sp === "string";
    ...
    function $159(__$callback) {
        return __$callback.call(this, null, this["ctx"]["attrs"]);
    }
    function $163(__$callback) {
        return __$callback.call(this, null, undefined);
    }
    function $167(__$callback) {
        return __$callback.call(this, null, {
            elem: "ico"
        });
    }
    function $172(__$callback) {
        return __$callback.call(this, null, {
            block: "box"
        });
    }
    function $177(__$callback) {
        var __$i35;
        var __$i23;
        var __$i19;
        var __$i7;
        ...
        return __$callback.call(this, null, _$1omix);
    }
    ...
    function $191(__$callback) {
        return __$callback.call(this, null, undefined);
    }
    function $195(__$callback) {
        return __$callback.call(this, null, [ {
            elem: "twitter"
        }, {
            elem: "facebook"
    ...
    function $233(__$callback) {
        return __$callback.call(this, null, "author vcard");
    }
    function $238(__$callback) {
        return __$callback.call(this, null, "i-ua_js_no i-ua_css_standard");
    }
    function $242(__$callback) {
        return __$callback.call(this, null, undefined);
    }
    function $246(__$callback) {
        return __$callback.call(this, null, false);
    }
    function $248(__$callback) {
        return __$callback.call(this, null, false);
    }
    function $250(__$callback) {
        return __$callback.call(this, null, false);
    }
    function $252(__$callback) {
        return __$callback.call(this, null, false);
    }
    function $254(__$callback) {
        return __$callback.call(this, null, false);
    }
    function $256(__$callback) {
        return __$callback.call(this, null, false);
    }
    function $261(__$callback) {
        return __$callback.call(this, null, false);
    }
    function $265(__$callback) {
        return __$callback.call(this, null, undefined);
    }
    function $269(__$callback) {
        var __$i32;
        var __$i26;
        var __$i13;
        var __$i14;
    ...
    function $283(__$callback) {
        return __$callback.call(this, null, undefined);
    }
    function $285(__$callback) {
        return __$callback.call(this, null, undefined);
    }
        ...
        if (!this.ctx === false) {
            if (!this.ctx.link === false) {
                if (!!this._.isSimple(this.ctx) === false) {
                    return $290.call(this, __$callback);
                } else {
    ...
    function $304(__$callback) {
        var __t = this._mode;
        if (__t === "default") {
            return $306.call(this, __$callback);
        } else if (__t === "") {
            if (!this._.isSimple(this.ctx) === false) {
                return $309.call(this, __$callback);
            } else {
                if (!!this.ctx === false) {
                    return $312.call(this, __$callback);
                } else {
    ...
    function applySync(__$callback) {
        ...
        if (__t === "default") {
            ...
            if (__t === "social-ico") {
                ...
                } else if (__t === "facebook") {
                    return $135.call(this, __$callback);
                } else if (__t === "twitter") {
                ...
                if (!!this.elem === false) {
                    return $142.call(this, __$callback);
                } else {
                    return $163.call(this, __$callback);
                }
            } else if (__t === "b-page") {
                ...
                if (__t === "js") {
                    ...
                    if (!this.ctx.url === false) {
                        return $153.call(this, __$callback);
                    } else {
                        return $163.call(this, __$callback);
                    }
                } else if (__t === "favicon") {
                    ...
                    return $159.call(this, __$callback);
                } else {
                    return $163.call(this, __$callback);
                }
            } else {
            ...
            if (__t === "social-ico") {
                if (!this.elem === false) {
                    return $167.call(this, __$callback);
                } else {
                    return $191.call(this, __$callback);
                }
            } else if (__t === "github") {
                if (!!this.elem === false) {
                    return $172.call(this, __$callback);
                } else {
                    return $191.call(this, __$callback);
                }
            } else if (__t === "b-menu-vert") {
                if (this.elem === "layout-unit") {
                    return $177.call(this, __$callback);
                } else {
                    return $191.call(this, __$callback);
                }
            } else if (__t === "article") {
            ...
            if (__t === "social-ico") {
                if (!!this.elem === false) {
                    return $195.call(this, __$callback);
                } else {
                ...
                if (!!this.elem === false) {
                    return $205.call(this, __$callback);
                } else {
                    return $229.call(this, __$callback);
                }
            } else if (__t === "article") {
                if (!!this.elem === false) {
                    return $210.call(this, __$callback);
                } else {
                    return $229.call(this, __$callback);
                }
            } else if (__t === "logo") {
                if (!!this.elem === false) {
                    return $215.call(this, __$callback);
                } else {
                    return $229.call(this, __$callback);
                }
            } else if (__t === "header") {
                if (!!this.elem === false) {
                    return $220.call(this, __$callback);
                } else {
                    return $229.call(this, __$callback);
                }
            } else if (__t === "i-ua") {
                if (!!this.elem === false) {
                    return $225.call(this, __$callback);
                } else {
                    return $229.call(this, __$callback);
                }
            } else {
            ...
            if (__t === "footer") {
                if (!!this.elem === false) {
                    return $44.call(this, __$callback);
                } else {
            ...
            } else if (__t === "social-ico") {
                if (!this.elem === false) {
                    return $49.call(this, __$callback);
                } else {
                    return $129.call(this, __$callback);
                }
            } else if (__t === "main") {
                if (!!this.elem === false) {
                    return $89.call(this, __$callback);
                } else {
                    return $129.call(this, __$callback);
                }
            } else if (__t === "logo") {
                ...
                if (!!this.elem === false) {
                    return $99.call(this, __$callback);
                } else {
                    return $129.call(this, __$callback);
                }
            } else if (__t === "b-page") {
                var __t = this.elem;
                if (__t === "js") {
                    return $104.call(this, __$callback);
                } else if (__t === "css") {
                    if (!this.ctx.url === false) {
                    ...
                    return $113.call(this, __$callback);
                } else if (__t === "head") {
                ...
                if (__t === "details") {
                    ...
                    return $84.call(this, __$callback);
                } else {
                    return $129.call(this, __$callback);
                }
            } else {
            ...
            if (__t === "b-page") {
                ...
                if (__t === "js") {
                    ...
                    return $248.call(this, __$callback);
                } else if (__t === "favicon") {
                    return $250.call(this, __$callback);
                } else if (__t === "meta") {
                    return $252.call(this, __$callback);
                } else if (__t === "head") {
                    return $254.call(this, __$callback);
                } else if (__t === "root") {
                    return $256.call(this, __$callback);
                } else {
                    return $265.call(this, __$callback);
                }
            } else if (__t === "i-ua") {
                if (!!this.elem === false) {
                    return $261.call(this, __$callback);
                } else {
                    return $265.call(this, __$callback);
                }
            } else {
            ...
            if (this.block === "b-page") {
                if (!!this.elem === false) {
                    return $269.call(this, __$callback);
                } else {
                    return $286.call(this, __$callback);
                }
            } else {
            ...
            return $283.call(this, __$callback);
        } else if (__t === "js") {
            return $285.call(this, __$callback);
        } else if (__t === "cls") {
            var __t = this.block;
            if (__t === "article") {
                if (this.elem === "details") {
                    return $233.call(this, __$callback);
                } else {
                    return $242.call(this, __$callback);
                }
            } else if (__t === "b-page") {
                if (this.elem === "root") {
